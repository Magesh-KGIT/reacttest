...
const RawMaterial = ({ newItem = {}, handleInputChange }) => {
  const columnss = ['S.No', 'Part No', 'Name', 'Category', 'Qty', 'Unit', 'Store'];
  const columns = ['Part No', 'Name', 'Category', 'Qty', 'Unit', 'Store'];
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:3000/rawMaterials')
      .then(response => {
